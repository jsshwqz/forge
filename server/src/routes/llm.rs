...
pub const PRESETS: &[ProviderPreset] = &[
    ...
    ProviderPreset {
        id: "siliconflow",
        name: "硅基流动 (SiliconFlow / DeepSeek/Qwen)",
        base_url: "https://api.siliconflow.cn/v1",
        default_model: "deepseek-ai/DeepSeek-V3",
        default_low_model: Some("Qwen/Qwen2.5-Coder-7B-Instruct"),
        key_hint: "sk-...",
    },
    ProviderPreset {
        id: "dashscope",
        name: "阿里云通义千问 (DashScope / 百炼)",
    ...
    ProviderPreset {
        ...
        default_low_model: Some("glm-4-flash"),
        key_hint: "API Key (xxx.yyy)",
    },
    ProviderPreset {
        id: "moonshot",
        ...
        default_low_model: Some("moonshot-v1-8k"),
        key_hint: "sk-...",
    },
    ProviderPreset {
        id: "ollama",
